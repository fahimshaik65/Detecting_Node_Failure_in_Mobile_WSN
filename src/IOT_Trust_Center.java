...
public class IOT_Trust_Center implements ActionListener {
	JFrame jf;
	Container c;
	...
	IOT_Trust_Center() {
		jf = new JFrame("IOT_Trust_Center :: Detecting Node Failures in Mobile Wireless Networks");
		c = jf.getContentPane();
		c.setLayout(null);
